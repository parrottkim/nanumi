...
class AreaList extends ConsumerWidget {
  const AreaList({super.key, required this.text});

  final String text;

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final state = ref.watch(areaProvider(text));
    final notifier = ref.watch(areaProvider(text).notifier);
    return state.when(
