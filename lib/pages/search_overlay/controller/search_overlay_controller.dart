...
final domainProvider =
    StateNotifierProvider.family<DomainNotifier, List<Organization>, String>(
        (ref, text) => DomainNotifier(ref: ref, text: text));

class DomainNotifier extends StateNotifier<List<Organization>> {
  DomainNotifier({required this.ref, required this.text}) : super([]) {
    _fetchFirestoreData();
  }
